...
class Order (models.Model):
    ...
    file = models.FileField(upload_to='media/', null=True, blank=True, verbose_name="Instrukcja I", validators=[validate_file_size, validate_pdf])
    fileLanguage = models.CharField(max_length=20, verbose_name ='Język instrukcji I', null=True, blank=True)
    file2 = models.FileField(upload_to='media/', null=True, blank=True, verbose_name="Instrukcja II", validators=[validate_file_size, validate_pdf])
    file2Language = models.CharField(max_length=20, verbose_name ='Język instrukcji II', null=True, blank=True)
    file3 = models.FileField(upload_to='media/', null=True, blank=True, verbose_name="Instrukcja III", validators=[validate_file_size, validate_pdf])
    file3Language = models.CharField(max_length=20, verbose_name ='Język instrukcji III', null=True, blank=True)
    file4 = models.FileField(upload_to='media/', null=True, blank=True, verbose_name="Instrukcja IV", validators=[validate_file_size, validate_pdf])
